...
import './App.css';
import senacLogo from './assets/images/logos/senac.png'
import fiapLogo from './assets/images/logos/fiap.jpg'
import fatecLogo from './assets/images/logos/fatec.jpg'
import bairesdevLogo from './assets/images/logos/bairesdev.png';
import dbcLogo from './assets/images/logos/dbc.jpg';
import redventuresLogo from './assets/images/logos/redventures.png';
import bionexoLogo from './assets/images/logos/bionexo.jpg';
import bluefitLogo from './assets/images/logos/bluefit.jpg';
import idealTrendsLogo from './assets/images/logos/ideal-trends.png';
import cvPT from './assets/doc/resume-shiguemori-pt.pdf';
import cvEN from './assets/doc/resume-shiguemori.pdf';
import profileImage from './assets/images/profile.jpg';
import linkedinLogo from './assets/images/logos/linkedin.png';
import githubLogo from './assets/images/logos/github.png';

const currentYear = new Date().getFullYear();
const yearsOfExperience = currentYear - 2012;
...
function App() {
    ...
    const cvPath = language === 'pt' ? cvPT : cvEN;
    // Parallax effects
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6">
                                Vinícius
                                <span
                                    className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">
                  Shiguemori
                </span>
                            </h1>
                        ...
                        >
                            <div className="relative w-80 h-80 mx-auto">
                                <div
                                    className="absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full blur-3xl opacity-30 animate-pulse"/>
                                <img
                                    src={profileImage}
                        ...
                        >
                            <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <p className="text-gray-400">{yearsOfExperience}+ Anos</p>
                                </CardContent>
                            </Card>
                        </motion.div>
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex flex-col lg:flex-row gap-6">
                                            ...
                                            <div className="flex-grow">
                                                <div
                                                    className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4">
                                                    <div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        {education.map((edu, index) => (
                            ...
                            >
                                <Card
                                    className="bg-white/5 border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 h-full">
                                    <CardContent className="p-6">
            ...
            <section id="contact" className="py-20 bg-black/20">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid lg:grid-cols-5 gap-4 max-w-6xl mx-auto">
                        ...
                        >
                            <a
                                href="mailto:shiguemori@hotmail.com"
                                target="_blank"
                        ...
                        >
                            <a
                                href="https://wa.me/5511975676977"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <Card
                        ...
                        <motion.div
                            ...
                            transition={{duration: 0.8, delay: 0.3}}
                            viewport={{once: true}}>
                            <a href="https://br.linkedin.com/in/shiguemori-shirakawabe" target="_blank"
                               rel="noopener noreferrer">
                                <Card
                                    className="bg-white/5 border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:scale-105">
                                    <CardContent className="p-6 text-center">
                        ...
                        <motion.div
                            ...
                            transition={{duration: 0.8, delay: 0.3}}
                            viewport={{once: true}}>
                            <a href="https://github.com/shiguemori" target="_blank"
                               rel="noopener noreferrer">
                                <Card
                                    className="bg-white/5 border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:scale-105">
                                    <CardContent className="p-6 text-center">
                                        <img
                                            src={githubLogo}
                                            alt="GitHub"
                                            className=" h-12 text-green-400 mx-auto mb-4"/>
                                        <h3 className="text-xl font-semibold text-white mb-2">
                                            {t.contact.github}
                                        </h3>
                                        <p className="text-gray-400">
            ...
            <footer className="py-8 border-t border-white/10">
                <div className="container mx-auto px-6">
                    <div className="text-center">
                        <p className="text-gray-400">
                            © {currentYear} Vinícius Shiguemori
                            Shirakawabe. {language === 'pt' ? 'Todos os direitos reservados.' : 'All rights reserved.'}
                        </p>
                    </div>
                </div>
            </footer>
